...
//    Loading More
//
//    EDIT CLASS IN JAVA ACTIVITY
//
//package com.example.jsondemogetdata;
//
...
//
//            loadpost();{aama last ma pogressbar mukva nu}
//
//
//            Toast.makeText(MainActivity.this, "load", Toast.LENGTH_SHORT).show();
//            bottompogressbar.setVisibility(View.VISIBLE);
//
//        }
//    }
//
//);
//
//    postdata();{aama vachhe pogressBar mukvanu }
//
//
//2 time api call krva ni
